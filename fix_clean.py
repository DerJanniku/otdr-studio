...
back_ag = """<div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 style={styles.title}>Ausbaugebiete</h1></div>"""
c = c.replace("<h1 style={styles.title}>Ausbaugebiete</h1>", back_ag)
...
back_kvz = """<div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 style={styles.title}>KVZs (NVTs)</h1></div>"""
c2 = c2.replace("<h1 style={styles.title}>KVZs (NVTs)</h1>", back_kvz)
