...
c = c.replace("interface Props {", "interface AusbaugebietDashboardProps {\n  parentProjectId: string;\n  onBack: () => void;")
...
c = c.replace("<h2 style={styles.title}>Ausbaugebiete</h2>", back_btn)
...
c2 = c2.replace("interface Props {", "interface KvzDashboardProps {\n  parentAusbaugebietId: string;\n  onBack: () => void;")
...
c2 = c2.replace("<h2 style={styles.title}>KVZs (NVTs)</h2>", back_btn2)
